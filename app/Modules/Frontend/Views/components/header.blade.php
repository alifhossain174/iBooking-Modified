...
<header class="site-header m-auto" style="max-width: 1150px;">
    ...
    <div class="user-navigation px-3">
        <ul>
            @if ($is_logged)
                @php
                ...
                {{-- <li id="gmz-dropdown-notification" class="dropdown notifications"
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                        ...
                        <a href="{{ dashboard_url('notifications') }}"
                            class="dropdown-item text-center notify-item notify-all">
                            {{ __('View All') }}
            ...
            @if (!$is_logged)
                ...
                <li><a href="#gmz-login-popup" style="background-color: #df1995; border-color:#df1995"
                        class="btn btn-sm btn-dark gmz-box-popup p-2" data-effect="mfp-zoom-in"><i
                            class="fal fa-sign-in pr-2"></i>{{ __('Sign In') }}</a></li>
            @else
                    ...
                    <div class="user-dropdown">
                        <ul>
                            ...
                            @if (is_admin())
                                <li>
                                    <a
                                        href="{{ dashboard_url('settings') }}">{!! get_icon('icon_system_settings') !!}{{ __('Settings') }}</a>
                                </li>
                            @endif
                            <li>
                                <a
                                    href="{{ dashboard_url('profile') }}">{!! get_icon('icon_system_user') !!}{{ __('Your Profile') }}</a>
                            </li>
                            <li>
